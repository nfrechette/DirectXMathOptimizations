...
PUBLIC ?XMMatrixMultiply_V4_Mem2_Impl@@YAXPEBM0PEAM@Z
PUBLIC ?XMMatrixMultiply_V4_RegExp2_Impl@@YQXPEBMPEAMT__m128@@222@Z

; M1 = rcx
; M2 = rdx
; Result = r8
_XMMatrixMultiply_V4_Mem2_Impl SEGMENT ALIGN(32) 'CODE'
?XMMatrixMultiply_V4_Mem2_Impl@@YAXPEBM0PEAM@Z PROC
...
_loop:
	...
	jge _loop
	ret
?XMMatrixMultiply_V4_Mem2_Impl@@YAXPEBM0PEAM@Z ENDP
_XMMatrixMultiply_V4_Mem2_Impl ENDS
...
_loop:
	...
	jge _loop
	ret
?XMMatrixMultiply_V4_RegExp2_Impl@@YQXPEBMPEAMT__m128@@222@Z ENDP
_XMMatrixMultiply_V4_RegExp2_Impl ENDS
