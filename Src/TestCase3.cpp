...
void TestCase3(const __int32 random_seed, const __int32 num_samples, const __int32 num_iterations, std::stringstream* output_)
{
	std::stringstream& output = *output_;

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Reg(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Reg2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_RegFlip(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_RegFlip2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_RegExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Mem(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Mem2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Inl(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_Inl2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_InlExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_Ref_InlExp2(random_seed, num_iterations, output);

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Reg(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Reg2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_RegFlip(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_RegFlip2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_RegExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Mem(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Mem2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Inl(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_Inl2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_InlExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V0_InlExp2(random_seed, num_iterations, output);

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Reg(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Reg2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_RegFlip(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_RegFlip2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_RegExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Mem(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Mem2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Inl(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_Inl2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_InlExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V1_InlExp2(random_seed, num_iterations, output);

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Reg(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Reg2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_RegFlip(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_RegFlip2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_RegExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Mem(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Mem2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Inl(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_Inl2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_InlExp(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V2_InlExp2(random_seed, num_iterations, output);

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V3_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V3_Mem2(random_seed, num_iterations, output);

	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V4_RegExp2(random_seed, num_iterations, output);
	for (__int32 i = 0; i < num_samples; ++i) TestCase3_V4_Mem2(random_seed, num_iterations, output);
}
